...
Router.prototype.route = function(method, url, callback) {
  ...
  // this is a variable that references the METHOD'S ARRAY
  // PASS BY REFERENCE
...
// -> if a route ma{tches, then we invoke the callback, which passes
// -> the request and reponse
// works for both GET and POST
// if the handle is not found, then the router should throw an error
// also with status code such as 404
